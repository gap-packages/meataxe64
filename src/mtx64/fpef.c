/*
    fpef.c meataxe-64 subroutine "Produce Echelon Form"
    ====== J G Thackray 13.08.15  R A Parker 26.11.16  ======
*/
...
int fpef(const char *in, const char * outbs, const char * outrm, int silent)
{
    FIELD *f;
    DSPACE ds,ds1;
    EFIL * e;
