...
// int pcbitread(uint64 *bs, uint64 bitno)
// %eax             %rdi        %rsi
	.text
	.globl	pcbitread
	.type	pcbitread, @function
pcbitread:
        xorl    %eax,%eax
        btq     %rsi,(%rdi)
        adcl    $0,%eax
        ret
	.size	pcbitread, .-pcbitread

// void pcbitset(uint64 *bs, uint64 bitno)
//                  %rdi        %rsi
	.text
	.globl	pcbitset
	.type	pcbitset, @function
pcbitset:
        btsq    %rsi,(%rdi)
        ret
	.size	pcbitset, .-pcbitset
